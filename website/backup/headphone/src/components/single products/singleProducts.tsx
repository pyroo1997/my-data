...
import prod1 from "../../assets/products/headphone-prod-4.webp";
    ...
    <div>
      <div className=" p-10 w-60% mx-auto h-auto lg:flex lg:justify-between">
        <div className="bg-gray-100 lg:w-[45%]">
          <img className="mx-auto" src={prod1} alt="" />
        </div>
        <div className="lg:w-[50%]">
          ...
          <p className="text-xs text-gray-400 pb-8 lg:text-sm">
            ...
            quidem corrupti iste sit. Corrupti reprehenderit consequuntur iusto
            obcaecati nulla veritatis, repellat suscipit soluta in
            necessitatibus deleniti blanditiis, quo, itaque exercitationem..
          </p>
          <div className="flex pb-4">
            ...
            <button className="flex justify-center items-center px-2 ml-2 w-[150px] h-[30px] bg-purple-600">
              <Cart color={"#ffffff"} />
          ...
          <div className="flex pt-4">
            ...
            <h1 className="text-xs pb-2 text-gray-500">Smat Watches</h1>
          </div>
          <div className="flex">
